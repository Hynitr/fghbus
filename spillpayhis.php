        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                  ...
                  $sql = "SELECT * FROM feercrd WHERE `descr` = 'SpillOver Payment' AND `adid` = '$data' ORDER BY id desc";
                  $rsl = query($sql);
                  ...
                  ?>
                                    <tr>
                                        ...
                                        <td><a href="./spillrec?id=<?php echo $row['feeid']?>">Print Receipt</a>
                                        </td>
                                    </tr>
                                    <?php
              }
