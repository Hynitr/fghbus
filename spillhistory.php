                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-header bg-danger">
                            ...
                            <h3 class="card-title"><?php echo $data ?> SpillOver History</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                  ...
                  $sql = "SELECT * FROM spillover WHERE `name` = '$data' AND `adid` = '$adid' ORDER BY id desc";
                  $rsl = query($sql);
                  ...
                  ?>
                                    <tr>
                                        ...
                                        <td><?php echo $row['term']." - ".$row['session'] ?> Session</td>
                                    </tr>
                                    <?php
              }
              ?>
